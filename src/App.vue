...
<template>
  <a-row type="flex" :gutter="[0,0]">
    <a-col flex="400px">
      ...
      <a-row class="title-box">
        <div>
          <a-divider orientation="left">Next step</a-divider>
          <div>
            The zdf file generated by this tool does not include tide data for the tide stations that were created. However, the AusSeabed Tide Tool will generate
            these data files for any zdf file. More details on this tool can be found <a target="_blank" href="https://github.com/ausseabed/tide-tool/">here</a>.
          </div>
        </div>
      </a-row>
